...
// shapes here match extension/tools/audio/lm/core.ts exactly — see that
...
export type ZzfxInitPayload = {
  ...
  lmAvailable: boolean
  /** The full curated preset library (`extension/tools/audio/lm/core.ts`'s
   ...
   * `extension/tools/audio/history/core.ts`'s `historyKeyFor`. */
   ...
   * mapping lives host-side in webview/audio/volumeTrim.ts, shared with
