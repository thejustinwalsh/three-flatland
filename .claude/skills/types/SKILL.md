...
See [patterns.md](references/enterprise-patterns.md) for comprehensive migration guides.
...
- [types.md](references/type-system.md) — Complete type system guide
- [generics.md](references/generics.md) — Advanced generics patterns
- [patterns.md](references/enterprise-patterns.md) — Error handling, validation, architecture
- [react.md](references/react-integration.md) — React + TypeScript patterns
