...
SpriteGroup now preserves hierarchy ownership through reparenting, React Activity retention, clipping, picking, auto-batch adoption, and cross-world transfers. Render-target binding and renderer state are restored across both direct and post-processed rendering, including failure paths.
