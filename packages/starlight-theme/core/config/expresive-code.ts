import { createInlineSvgUrl, type StarlightExpressiveCodeOptions } from '@astrojs/starlight/expressive-code'
import type { StarlightUserConfig } from '@astrojs/starlight/types'

export const expressiveCode = (config: StarlightUserConfig): boolean | StarlightExpressiveCodeOptions => {
