...
- The three-flatland aesthetic (technicolor gem palette on near-black, Crafted/Expressive/Performant per `AGENTS.md > Design Context`) diverges from lucode's shadcn-derivative starting point. Component overrides will progressively drift.
