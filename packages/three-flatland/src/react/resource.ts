...
import type { TextureLoaderOptions } from '../loaders/TextureLoader'
 ...
 * @example
 * ```tsx
 * import { createResource } from 'three-flatland/react'
 *
 ...
 * @example
 * ```tsx
 * import { spriteSheet } from 'three-flatland/react'
 ...
 * @example
 * ```tsx
 * import { texture } from 'three-flatland/react'
 * import { use } from 'react'
 *
