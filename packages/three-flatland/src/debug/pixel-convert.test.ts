...
describe('convertToRGBA8', () => {
  ...
  it('r8 + mono: single byte expanded to greyscale', () => {
    ...
    expect(out[12]).toBe(64)
    expect(out[13]).toBe(64)
    expect(out[14]).toBe(64)
  ...
  it('rgba16f + normalize: auto min/max remap', () => {
    ...
    const u16 = new Uint16Array(8)
    u16[0] = floatToHalf(0)
    u16[1] = floatToHalf(0.5)
    u16[2] = floatToHalf(0)
    u16[3] = floatToHalf(1)
    u16[4] = floatToHalf(1)
    u16[5] = floatToHalf(0.5)
    u16[6] = floatToHalf(0)
    u16[7] = floatToHalf(1)
  ...
  it('rgba32f + normalize: per-channel remap', () => {
    const f32 = new Float32Array([0, 10, 0, 1, 100, 10, 50, 1])
  ...
  it('rgba32f + colors: produces valid RGBA8', () => {
    ...
    const f32 = new Float32Array([0.5, 0, 1.0, 1, 2.0, -0.5, 0.5, 0, 0, 0, 0, 1, 1, 1, 1, 1])
  ...
  it('rgba16f with 256-byte row padding produces correct output', () => {
    ...
    u16[row1 + 1] = 0
    u16[row1 + 2] = 0
    u16[row1 + 3] = floatToHalf(1)
    u16[row1 + 4] = floatToHalf(0) // px(1,1).R
    u16[row1 + 5] = 0
    u16[row1 + 6] = 0
    u16[row1 + 7] = floatToHalf(1)
    u16[row1 + 8] = floatToHalf(0.25) // px(2,1).R
    u16[row1 + 9] = 0
    u16[row1 + 10] = 0
    u16[row1 + 11] = floatToHalf(1)
    ...
    expect(out[0]).toBe(0)
    expect(out[1]).toBeGreaterThan(0) // px(0,0) green
    expect(out[4]).toBeGreaterThan(0)
    expect(out[5]).toBe(0) // px(1,0) red
    expect(out[8]).toBe(0)
    expect(out[9]).toBeGreaterThan(200) // px(2,0) green

    // Row 1: -1.0 → red, 0 → black, +0.25 → green
    expect(out[12]).toBeGreaterThan(200)
    expect(out[13]).toBe(0) // px(0,1) red
    expect(out[16]).toBe(0)
    expect(out[17]).toBe(0) // px(1,1) black
    expect(out[20]).toBe(0)
    expect(out[21]).toBeGreaterThan(0) // px(2,1) green
  })
  ...
  it('rgba8 with row padding reads correctly', () => {
    ...
    expect(out[13]).toBe(128)
    expect(out[14]).toBe(0)
    expect(out[16]).toBe(0)
    expect(out[17]).toBe(128)
    expect(out[18]).toBe(128)
    expect(out[20]).toBe(128)
    expect(out[21]).toBe(0)
    expect(out[22]).toBe(128)
  })
