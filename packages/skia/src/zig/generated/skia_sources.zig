// Auto-generated by parse_compile_commands.py — do not edit
// Regenerate: python3 scripts/parse_compile_commands.py --gl <gl.json> --wgpu <wgpu.json>

// ── Shared (compiled into both GL and WebGPU variants) ──

pub const core_files: []const []const u8 = &.{
...
pub const pathops_files: []const []const u8 = &.{
...
pub const text_files: []const []const u8 = &.{
...
// ── GL-specific (Ganesh + GL backend) ──

pub const gl_gpu_files: []const []const u8 = &.{
    "src/gpu/Blend.cpp",
    ...
    "src/gpu/ganesh/GrAtlasTypes.cpp",
...
// ── WebGPU-specific (Graphite + Dawn backend) ──

pub const wgpu_gpu_files: []const []const u8 = &.{
    "src/gpu/Blend.cpp",
    "src/gpu/BlendFormula.cpp",
    "src/gpu/BlurUtils.cpp",
    "src/gpu/DataUtils.cpp",
    ...
    "src/gpu/graphite/ClipStack.cpp",
    ...
    "src/gpu/graphite/SerializationUtils.cpp",
    ...
    "src/gpu/graphite/ThreadSafeResourceProvider.cpp",
...
// ── Include paths (union of both builds) ──
...
pub const include_paths: []const []const u8 = &.{
    ...
    "modules/svg/include",
    "out/wasm-webgpu/gen/third_party/dawn/include",
