 ...
 */
export function dmgPalette(inputColor: Node<'vec4'>, contrast: FloatInput = 1): Node<'vec4'> {
 ...
 */
export function pocketPalette(inputColor: Node<'vec4'>, contrast: FloatInput = 1): Node<'vec4'> {
  const contrastNode = typeof contrast === 'number' ? float(contrast) : contrast
 ...
 */
export function ppuPalette(inputColor: Node<'vec4'>, saturation: FloatInput = 1): Node<'vec4'> {
 ...
 */
export function md9bitPalette(inputColor: Node<'vec4'>): Node<'vec4'> {
 ...
 */
export function vbPalette(inputColor: Node<'vec4'>, contrast: FloatInput = 1): Node<'vec4'> {
  const contrastNode = typeof contrast === 'number' ? float(contrast) : contrast
 ...
 */
export function gbcPalette(inputColor: Node<'vec4'>): Node<'vec4'> {
 ...
 */
export function snesPalette(inputColor: Node<'vec4'>): Node<'vec4'> {
  // 5 bits per channel = 32 levels = 32768 colors
  const r = floor(inputColor.r.mul(31.99)).div(31)
  const g = floor(inputColor.g.mul(31.99)).div(31)
  const b = floor(inputColor.b.mul(31.99)).div(31)
 ...
 */
export function cgaPalette(inputColor: Node<'vec4'>): Node<'vec4'> {
  const luma = inputColor.r.mul(0.299).add(inputColor.g.mul(0.587)).add(inputColor.b.mul(0.114))
 ...
 */
export function c64Palette(inputColor: Node<'vec4'>): Node<'vec4'> {
  ...
  let r: Node<'float'> = lumaLevel
  let g: Node<'float'> = lumaLevel
  let b: Node<'float'> = lumaLevel
