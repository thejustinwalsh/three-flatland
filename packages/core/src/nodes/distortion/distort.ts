import { vec2, float, cos, sin, floor } from 'three/tsl'
 ...
 */
export function distortPixelate(uv: Node<'vec2'>, pixelSize: FloatInput = 0.05): Node<'vec2'> {
 ...
 * @returns Pixelated UV coordinates
 */
export function distortPixelateCount(uv: Node<'vec2'>, pixelCount: FloatInput = 64): Node<'vec2'> {
