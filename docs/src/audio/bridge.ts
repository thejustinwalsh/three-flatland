...
class AudioBridge {
  ...
  constructor(zzfx: typeof import('zzfx'), zzfxm: typeof import('@zzfx-studio/zzfxm'), library: TracksLibrary | null) {
  ...
  playSfx(params: ZzFxParams): void {
    ...
    const sampleArray = samples instanceof Float32Array ? samples : new Float32Array(samples as ArrayLike<number>)
