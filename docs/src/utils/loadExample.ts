 ...
 */
export function loadExample(type: 'three' | 'react', name: string): Record<string, string> {
  ...
  // Copy source files
  const sourceFiles = ['index.html', 'main.ts', 'main.tsx', 'App.tsx', 'style.css', 'styles.css']
