...
export const beats: SceneBeat[] = [
  ...
  { camera: { position: [-0.5, 0, 9], lookAt: [0, 0, 0], zoom: 1 } }, // 8 feature breakdown
  { camera: { position: [0, 1, 16], lookAt: [0, 0, 0], zoom: 1 } }, // 9 GO NATIVE (wide)
  { camera: { position: [0, 0, 7], lookAt: [0, 0, 0], zoom: 1 } }, // 10 AI / agents (head-on, direct)
  { camera: { position: [0, 0, 9], lookAt: [0, 0, 0], zoom: 1 } }, // 11 close
]
