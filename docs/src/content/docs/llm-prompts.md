...
|------|------------------|----------------|
| [`llms.txt`](/llms.txt) | Links to all docs pages, guides, and examples | AI tools that can browse and follow links |
| [`llms-full.txt`](/llms-full.txt) | Self-contained API reference with imports, classes, effects, and examples | AI tools that need everything in one file |
