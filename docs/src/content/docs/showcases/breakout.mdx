...
import ShowcaseDetailLayout from '../../../components/ShowcaseDetailLayout.astro';
import ShowcaseGame from '../../../components/ShowcaseGame';

<ShowcaseDetailLayout slug="breakout" sourcePath="minis/breakout" gem="ruby">
  <ShowcaseGame slot="preview" client:load />
