...
- [Flatland Guide](../guides/flatland) — Wrap SpriteGroup with camera, post-processing, and global uniforms
- [Sprites Guide](../guides/sprites) — Sprite2D properties and configuration
