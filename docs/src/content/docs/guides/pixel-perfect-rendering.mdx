...
See the [`PixelPerfectCamera` API reference](/three-flatland/api/three-flatland/src/classes/pixelperfectcamera/), [`FlatlandOptions`](/three-flatland/api/three-flatland/src/interfaces/flatlandoptions/), and [`Sprite2D`](/three-flatland/api/three-flatland/src/classes/sprite2d/) for the complete option and property surfaces.
