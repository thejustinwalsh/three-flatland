...
The `@three-flatland/slug` API isn't settled yet. We're dogfooding it and folding in [community feedback](https://github.com/thejustinwalsh/three-flatland/issues?q=is%3Aissue+label%3Aslug) to stabilize it, so it can shift between releases. Pin an exact version for now.
:::
