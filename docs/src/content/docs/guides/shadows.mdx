...
import shadowTrace from '../../../assets/diagrams/shadow-sdf-trace.svg?raw';
import shadowElevation from '../../../assets/diagrams/shadow-elevation.svg?raw';
...
<Diagram caption="The shadow pipeline — casters become an occlusion mask, JFA builds a signed distance field, and each lit fragment sphere-traces toward the light through it" src={shadowTrace} />
