...
See the [2D Lighting guide](../guides/lighting) for preset comparisons, Light2D types, and custom effects.
...
- [2D Lighting](../guides/lighting) — Light2D sources and LightEffect presets
