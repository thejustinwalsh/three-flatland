---
title: Migrate away from ECS internals
description: Update an existing three-flatland project for the private ECS runtime and stricter lifecycle contracts.
---
