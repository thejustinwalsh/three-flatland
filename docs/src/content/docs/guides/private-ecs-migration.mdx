...
storage, and query model made the specialized design possible, and Koota remains a good fit for
application-owned gameplay state. This migration removes a package-level renderer dependency; it
does not replace Koota as a general-purpose ECS.
