...
<Diagram caption="The animation data path — atlas frames are grouped into named clips, then play() picks the active clip and update(deltaMs) advances its frames over time." src={animationPipeline} />
