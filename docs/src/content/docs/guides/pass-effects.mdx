...
```typescript
import { createPassEffect, posterize } from '@three-flatland/core'
...
<Tabs syncKey="framework">
  <TabItem label="Three.js" icon="seti:javascript">
    ```typescript
    import { Flatland, createPassEffect, posterize, crtVignette } from '@three-flatland/core'
  ...
  <TabItem label="React" icon="seti:react">
    ...
    import {
      Flatland, createPassEffect, posterize, crtVignette,
...
import { createPassEffect, vhsDistortion } from '@three-flatland/core'
...
All post-processing nodes are exported from `@three-flatland/core`:
