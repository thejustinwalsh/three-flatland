...
import passChainFusion from '../../../assets/diagrams/passeffect-chain-fusion.svg?raw';

<Diagram caption="Three effect layers in the render pipeline" src={effectLayers} />
...
<Diagram caption="Pass-chain cost — color-math passes fuse into one GPU program; a UV-sampling pass forces a convertToTexture boundary (render to texture, then sample)." src={passChainFusion} />
