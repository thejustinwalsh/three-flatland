...
- Updated dependencies [939cd64]
  ...
  - @three-flatland/presets@0.1.0-alpha.11
...
- Updated dependencies [9d733a7]
  ...
  - @three-flatland/presets@0.1.0-alpha.10

## 0.0.1-alpha.3

### Patch Changes

- 2460dc0: build: astro 6 → 7.1.3 with the starlight-0.41 plugin chain (@astrojs/starlight
...
- Updated dependencies [2460dc0]
  - starlight-theme@0.0.1-alpha.3
...
- Updated dependencies [261b5be]
  ...
  - @three-flatland/presets@0.1.0-alpha.8
