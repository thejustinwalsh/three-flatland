...
@binding( 4 ) @group( 1 ) var nodeUniform9_sampler : sampler;
@binding( 5 ) @group( 1 ) var nodeUniform9 : texture_2d<f32>;
...
fn main( @location( 0 ) nodeVarying4 : vec2<f32> ) -> OutputStruct {
	...
	if ( ( nodeVar2 > 0.0 ) ) {
		...
		nodeVar105 = 0.0;
		nodeVar106 = ( ( rcRayIndex * 4.0 ) + 0.0 );
		nodeVar107 = clamp( ( rcProbeXY * vec2<f32>( 0.5 ) ), vec2<f32>( 0.5, 0.5 ), vec2<f32>( 20.5, 12.5 ) );
		nodeVar108 = textureSample( nodeUniform9, nodeUniform9_sampler, ( ( ( vec2<f32>( tsl_mod_float( nodeVar106, 32.0 ), floor( ( nodeVar106 / 32.0 ) ) ) * vec2<f32>( 21.0, 13.0 ) ) + nodeVar107 ) / vec2<f32>( 672.0, 416.0 ) ) );
		nodeVar109 = vec4<f32>( ( nodeVar108.xyz * vec3<f32>( object.nodeUniform10 ) ), nodeVar108.w );
		nodeVar104 = ( nodeVar104 + nodeVar109.xyz );
		nodeVar105 = ( nodeVar105 + nodeVar109.w );
		nodeVar110 = ( ( rcRayIndex * 4.0 ) + 1.0 );
		nodeVar111 = textureSample( nodeUniform9, nodeUniform9_sampler, ( ( ( vec2<f32>( tsl_mod_float( nodeVar110, 32.0 ), floor( ( nodeVar110 / 32.0 ) ) ) * vec2<f32>( 21.0, 13.0 ) ) + nodeVar107 ) / vec2<f32>( 672.0, 416.0 ) ) );
		nodeVar112 = vec4<f32>( ( nodeVar111.xyz * vec3<f32>( object.nodeUniform10 ) ), nodeVar111.w );
		nodeVar104 = ( nodeVar104 + nodeVar112.xyz );
		nodeVar105 = ( nodeVar105 + nodeVar112.w );
		nodeVar113 = ( ( rcRayIndex * 4.0 ) + 2.0 );
		nodeVar114 = textureSample( nodeUniform9, nodeUniform9_sampler, ( ( ( vec2<f32>( tsl_mod_float( nodeVar113, 32.0 ), floor( ( nodeVar113 / 32.0 ) ) ) * vec2<f32>( 21.0, 13.0 ) ) + nodeVar107 ) / vec2<f32>( 672.0, 416.0 ) ) );
		nodeVar115 = vec4<f32>( ( nodeVar114.xyz * vec3<f32>( object.nodeUniform10 ) ), nodeVar114.w );
		nodeVar104 = ( nodeVar104 + nodeVar115.xyz );
		nodeVar105 = ( nodeVar105 + nodeVar115.w );
		nodeVar116 = ( ( rcRayIndex * 4.0 ) + 3.0 );
		nodeVar117 = textureSample( nodeUniform9, nodeUniform9_sampler, ( ( ( vec2<f32>( tsl_mod_float( nodeVar116, 32.0 ), floor( ( nodeVar116 / 32.0 ) ) ) * vec2<f32>( 21.0, 13.0 ) ) + nodeVar107 ) / vec2<f32>( 672.0, 416.0 ) ) );
		nodeVar118 = vec4<f32>( ( nodeVar117.xyz * vec3<f32>( object.nodeUniform10 ) ), nodeVar117.w );
		nodeVar104 = ( nodeVar104 + nodeVar118.xyz );
		nodeVar105 = ( nodeVar105 + nodeVar118.w );
		nodeVar104 = ( nodeVar104 * vec3<f32>( 0.25 ) );
		nodeVar105 = ( nodeVar105 * 0.25 );
		nodeVar102 = ( nodeVar102 + ( vec3<f32>( nodeVar103 ) * nodeVar104 ) );
		nodeVar103 = ( nodeVar103 * nodeVar105 );


	}

	nodeVar119 = vec4<f32>( nodeVar102, nodeVar103 );

	// result

	output.color = vec4<f32>( ( floor( ( ( clamp( ( nodeVar119.xyz / vec3<f32>( object.nodeUniform10 ) ), vec3<f32>( 0.0 ), vec3<f32>( 1.0 ) ) * vec3<f32>( object.nodeUniform11 ) ) + vec3<f32>( 0.5 ) ) ) / vec3<f32>( object.nodeUniform11 ) ), ( floor( ( ( clamp( nodeVar119.w, 0.0, 1.0 ) * object.nodeUniform11 ) + 0.5 ) ) / object.nodeUniform11 ) );
