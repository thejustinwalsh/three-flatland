...
@binding( 5 ) @group( 0 ) var nodeUniform10 : texture_storage_2d<rgba8unorm, write>;

struct NodeBuffer_10357Struct {
	value : array< atomic<u32> >
};
@binding( 0 ) @group( 0 )
var<storage, read_write> NodeBuffer_10357 : NodeBuffer_10357Struct;
...
fn main( @builtin( global_invocation_id ) globalId : vec3<u32>,
	...
	// flow -> dda-workgroup-cascade-3

	for ( var i : i32 = 0; i < 70; i ++ ) {

		let nodeConst0 = atomicAdd( &NodeBuffer_10357.value[ 0u ], 1u );
		...
		nodeVar103 = nodeVar1;
		nodeVar104 = nodeVar2;
		nodeVar105 = vec4<f32>( nodeVar103, nodeVar104 );
		textureStore( nodeUniform10, vec2<u32>( rcComputeAtlasCell ), vec4<f32>( ( floor( ( ( clamp( ( nodeVar105.xyz / vec3<f32>( object.nodeUniform11 ) ), vec3<f32>( 0.0 ), vec3<f32>( 1.0 ) ) * vec3<f32>( object.nodeUniform12 ) ) + vec3<f32>( 0.5 ) ) ) / vec3<f32>( object.nodeUniform12 ) ), ( floor( ( ( clamp( nodeVar105.w, 0.0, 1.0 ) * object.nodeUniform12 ) + 0.5 ) ) / object.nodeUniform12 ) ) );
