...
export const SAG_DURATION_TICKS = SAG_PRECARIOUS_TICKS + SAG_SAGGING_TICKS + SAG_SHAKING_TICKS
...
/** Brief impact read after a fall: two landing frames plus a short final hold. */
export const LANDING_STUN_MS = 280
/** Rows descended before the looping airborne animation begins. */
export const FALL_ANIMATION_START_ROWS = 3
/** Short drops through three rows stay responsive and do not incur landing stun. */
export const LANDING_STUN_START_ROWS = 4
/**
