...
import { Fn, clamp, float, mix, texture as textureNode, uniform, uv, vec2, vec3, vec4 } from 'three/tsl'
...
const SKY_BLUE: readonly [number, number, number] = [0.30, 0.45, 0.66]
...
void uniform // keep import alive for type re-export upstream
