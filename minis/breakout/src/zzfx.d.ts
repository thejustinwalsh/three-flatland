 ...
 *
 * The positional 21-param `ZzFXParams` tuple lives in `./types.ts`; this
 * file only declares the package's external surface so TypeScript stops
 * warning about implicit-any imports.
 */
declare module 'zzfx' {
